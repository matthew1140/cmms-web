...
@Component({
  selector: 'app-admin-proceeding',
  templateUrl: './admin-proceeding.component.html',
  styleUrls: ['./admin-proceeding.component.css']
})
export class AdminProceedingComponent implements OnInit, AfterViewInit {
