...
@Component({
  selector: 'app-today-issue',
  templateUrl: './today-issue.component.html',
  styleUrls: ['./today-issue.component.css']
})
export class TodayIssueComponent implements OnInit {
    ...
    initTable() {
      ...
      table.on('click', 'td', function(this: any) {
        ...
        self._router.navigate(['tech/edit-issue', self.issue]);
      });
